        ...
        <ScrollView style={{ flex:1 }}>
            <View style={{ flex: 1, padding: 16 }}>
                ...
                style={{
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/11/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                        <Text style = {{ paddingLeft:20 }}>Discount : 10%</Text>
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/10/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                        <Text style = {{ paddingLeft:20 }}>Discount : 10%</Text>
                        <Text style = {{ paddingLeft:20 }}>Price : RP 1.000.000.000,00</Text>
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/09/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                        <Text style = {{ paddingLeft:20 }}>Discount : 10%</Text>
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/08/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/07/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                        <Text style = {{ paddingLeft:20 }}>Discount : 20%</Text>
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/06/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                        <Text style = {{ paddingLeft:20 }}>Discount : 20%</Text>
                    ...
                    <View style={styles.item}>
                        <View style={styles.overview}>
                        <Text style = {{ paddingLeft:20 }}>01/05/2020</Text>
                        <Text style = {{ paddingLeft:20 }}>Payment</Text>
                        <Text style = {{ paddingLeft:20 }}>Item : Solar</Text>
                        <Text style = {{ paddingLeft:20 }}>Discount : 20%</Text>
                        <Text style = {{ paddingLeft:20 }}>Price : RP 990.000.000,00</Text>
